...
namespace VendorApp.Areas.Identity.Pages.Account
{
  ...
  public class RegisterModel : PageModel
  {
    ...
    private readonly UserManager<VendorAppUser> _userManager;
    private readonly ILogger<RegisterModel> _logger;
    private readonly IEmailSender _emailSender;

    public RegisterModel(
        UserManager<VendorAppUser> userManager,
        SignInManager<VendorAppUser> signInManager,
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
      ...
      {
        var user = new VendorAppUser { UserName = Input.Email, Email = Input.Email };
